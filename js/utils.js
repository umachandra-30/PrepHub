                ...
                <ul class="nav-links" id="nav-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" id="more-dropdown-menu">
                            ...
                            ${isLoggedInUser ? `<li><a href="roadmaps.html" class="${activePage === 'roadmaps.html' ? 'active' : ''}"><i class="lucide-map" style="font-size: 0.9rem; margin-right: 0.5rem; display: inline-block; vertical-align: middle;"></i><span>Road Map</span></a></li>` : ''}
